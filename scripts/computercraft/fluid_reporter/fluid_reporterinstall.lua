...
if (args[1]=="install") or (args[1]==nil) then
	...
	print("[Installer] Thank you for downloading the fluid_reporter software! Installing...")
	print("[Installer] Installing 'fluid_reporter'...")
	if downloadfile("fluid_reporter","https://cc.prophecypixel.com/scripts/computercraft/fluid_reporter/fluid_reporter.lua")==false then
		return false
	end
	print("[Installer] Successfully installed 'fluid_reporter'!")
elseif args[1]=="update" then
	print("[Installer] Updating 'fluid_reporter'...")
	if downloadfile("fluid_reporter","https://cc.prophecypixel.com/scripts/computercraft/fluid_reporter/fluid_reporter.lua")==false then
		return false
	end
elseif args[1]=="remove" then
	print("[Installer] Uninstalling 'adduser'...")
	fs.delete("/fluid_reporter.lua")
	shell.setCompletionFunction("fluid_reporter", nil)
