...
function read(opts)
  ...
  local complete_fg = opts.complete_fg or colour_table[settings.get("aes.readline.complete_fg")] or -1
  local complete_bg = opts.complete_bg or colour_table[settings.get("aes.readline.complete_bg")] or -1
