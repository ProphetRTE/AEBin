...
if (args[1]=="install") or (args[1]==nil) then
	...
	print("[Installer] Thank you for downloading the passwordsecurity software! Installing...")
	print("[Installer] Installing 'passwordsecurity'...")
	if downloadfile("passwordsecurity","https://cc.prophecypixel.com/scripts/computercraft/passwordsecurity/passwordsecurity")==false then
		return false
	end
	print("[Installer] Successfully installed 'passwordsecurity'!")
elseif args[1]=="update" then
	print("[Installer] Updating 'passwordsecurity'...")
	if downloadfile("passwordsecurity","https://cc.prophecypixel.com/scripts/computercraft/passwordsecurity/passwordsecurity")==false then
		return false
	end
