...
function createWebhook(url)
  ...
  if not success then
    ...
    function _.send(message, username, avatar)
      ...
      local success = send(_.url, data, { ["Content-Type"] = "application/x-www-form-urlencoded", ["Source"] = "Minecraft/ComputerCraft/AECord" })
    ...
    function _.sendJSON(json)
      ...
      local success = send(_.url, json, { ["Content-Type"] = "application/json", ["Source"] = "Minecraft/ComputerCraft/AECord" })
      if success then _.sentMessages = _.sentMessages + 1 end
      return success
    end
    ...
    function _.sendEmbed(message, title, description, link, colour, image_large, image_thumb, username, avatar)
      ...
      local success = send(_.url, textutils.serializeJSON(data), { ["Content-Type"] = "application/json", ["Source"] = "Minecraft/ComputerCraft/AECord" })
      if success then _.sentMessages = _.sentMessages + 1 end
      return success
    end
