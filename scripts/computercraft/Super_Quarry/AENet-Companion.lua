...
local expectedMessage = "AE's Quarry" --Expected initial message
...
Once you have done that, start the turtle and when it says "AENet?", say "Yes"
  Optionally, you can use the parameter "-aenet true"
