...
local AUTHOR_NOTE = "-[ JSON.lua package by AEVridis (http://regex.info/blog/lua/json) version 20140920.13 ]-"
...
-- replaced this line with return statement so that this file can be loaded as a module using dofile()
-- JSON = OBJDEF:new()
return OBJDEF:new()
