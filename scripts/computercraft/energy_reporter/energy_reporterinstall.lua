...
if (args[1]=="install") or (args[1]==nil) then
	...
	print("[Installer] Thank you for downloading the energy_reporter software! Installing...")
	print("[Installer] Installing 'energy_reporter'...")
	if downloadfile("energy_reporter","https://cc.prophecypixel.com/scripts/computercraft/energy_reporter/energy_reporter.lua")==false then
		return false
	end
	print("[Installer] Successfully installed 'energy_reporter'!")
elseif args[1]=="update" then
	print("[Installer] Updating 'energy_reporter'...")
	if downloadfile("energy_reporter","https://cc.prophecypixel.com/scripts/computercraft/energy_reporter/energy_reporter.lua")==false then
		return false
	end
elseif args[1]=="remove" then
	print("[Installer] Uninstalling 'adduser'...")
	fs.delete("/energy_reporter.lua")
